...
<?php if (!$no_render) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'C:\projects\demo\include\Smarty-3.0.4\libs\plugins\modifier.capitalize.php';
...
The current date and time is 2011-06-07 11:59:29

The value of global assigned variable $SCRIPT_NAME is /pams21/include/Smarty-3.0.4/demo/index.php
...
testing strip tags
<table border=0><tr><td><A HREF="/pams21/include/Smarty-3.0.4/demo/index.php"><font color="red">This is a  test     </font></A></td></tr></table>
