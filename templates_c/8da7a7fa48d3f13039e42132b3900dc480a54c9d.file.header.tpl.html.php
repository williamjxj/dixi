...
"> <?php echo (isset($_smarty_tpl->getVariable('common')->value['header']['logo']) ? $_smarty_tpl->getVariable('common')->value['header']['logo'] : null);?>
  ...
  <div class="span3">
    <ul>
      <li><a id="login_signup" href="login.php">用户注册</a></li>
...
<div id="menu" class="row">
  <div class="span12"> <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('menu_template')->value), $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
